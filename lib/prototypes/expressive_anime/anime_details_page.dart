...
class _AnimeDetailsPageState extends State<AnimeDetailsPage> {
  ...
  /// Load user's library data to check if anime is already in a list
  ...
  Future<void> _showListSelectionDialog(Anime anime) async {
    final listNames = await _dataService.getAvailableListNames();
            ...
            children: [
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isCurrentList = listName == _currentListName;
  ...
  /// Auto-adds to Current if not in a list when incrementing
  /// Auto-updates to Completed when reaching total episodes
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '$_currentEpisode / ${anime.episodes}',
                                                style: GoogleFonts.robotoMono(
                                                  fontSize: 18,
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.black,
